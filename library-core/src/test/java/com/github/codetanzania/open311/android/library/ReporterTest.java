...
public class ReporterTest {
    ...
    @Test
    public void reporter_canBeConvertedToAccessor() {
        ApiAccountRequest requestBody = new ApiAccountRequest(mockReporter);

        assertEquals("Username should be parsed correctly", mockName, requestBody.name);
        assertEquals("Phone number should be parsed correctly", mockNumber, requestBody.phone);
        assertEquals("Email should be parsed correctly", mockEmail, requestBody.email);
        assertEquals("Account Number should be parsed correctly", mockAccount, requestBody.account);
    ...
    private void assertMatchesMock(ApiReporter apiReporter) {
