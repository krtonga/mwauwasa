...
import static com.github.codetanzania.open311.android.library.MocksSrvcRq.*;
...
public class ProblemTest implements Problem.Builder.InvalidCallbacks {
    ...
    public static Problem buildMockProblem(Problem.Builder.InvalidCallbacks listener) {
        ...
        File file = MocksSrvcRq.createMockFile();
    ...
    public static void assertGetMatchesMock(Problem problem) {
        ...
        assertEquals("Ticket should not be open", false, problem.isOpen());
        ...
        DateUtilTest.testCalendar(problem.getResolvedAt(), 2018, Calendar.APRIL, 24, 1, 43, 3);
