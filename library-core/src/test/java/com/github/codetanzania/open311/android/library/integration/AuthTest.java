...
import com.github.codetanzania.open311.android.library.MocksSrvcRq;
...
public class AuthTest {
    ...
    public void setup() throws IOException {
        ...
        Auth auth = Auth.init(context, MocksSrvcRq.mockEndPoint);
    ...
    public void testSuccessSignin() {
        ...
        TestObserver<Party> signInObserver = new TestObserver<>();
    ...
    public class MockAPI implements Auth.API {
        ...
        MockAPI(BehaviorDelegate<Auth.API> delegate) {
