...
import com.github.codetanzania.open311.android.library.utils.KeyboardUtils;
...
//        }
    ...
    public String getPermissionAlertTitle() {
        return getString(R.string.location_permission_dialog_title, getString(R.string.app_name));
    }
    ...
    private void updateIssueLocation(LatLng location) {
        ...
        Location gpsPoint = new Location("Mapbox");
        gpsPoint.setLatitude(location.getLatitude());
        gpsPoint.setLongitude(location.getLongitude());
        FetchAddressIntentService.findAddressWithGoogle(getActivity().getApplicationContext(), gpsPoint,
