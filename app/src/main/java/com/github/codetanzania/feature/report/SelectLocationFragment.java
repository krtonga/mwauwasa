...
import com.github.codetanzania.util.MapUtils;
...
public class SelectLocationFragment extends MapboxBaseFragment implements
    ...
    private ObstructiveProgressDialog mLocationLoading;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (rootView != null) {
            ...
            mLocationLoading = new ObstructiveProgressDialog(getContext());
            mLocationLoading.show();
    ...
    public void onMapReady(MapboxMap mapboxMap) {
        ...
        // This limits map to bounds provided in string resources
        mapboxMap.setLatLngBoundsForCameraTarget(MapUtils.getCompanyBounds(getResources()));
    ...
    public String getPermissionAlertDescription() {
        return getString(R.string.location_permission_dialog_description, getString(R.string.app_name));
    }

    // This is called if turning on location permission or GPS is denied
    @Override
    public void onPermissionDenied() {
        String message = getString(R.string.location_permission_denied, getString(R.string.app_name));
    ...
    public void onLocationChanged(Location location) {
        // If progress bar is showing, hide it
        if (mLocationLoading != null && mLocationLoading.isShowing()) {
            mLocationLoading.dismiss();
        }
