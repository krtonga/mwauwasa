...
// WORK AROUND
// For some reason, the app intro library has a buggy update. This is a copy of the buggy fragment
// with some minor difference which are introduced in order to fix the bug.
public abstract class AppIntroBaseFragment extends Fragment implements ISlideSelectionListener,
    ...
    private static final String TAG = LogHelper.makeLogTag(com.github.paolorotolo.appintro.AppIntroBaseFragment.class);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        mainLayout = (RelativeLayout) v.findViewById(com.github.paolorotolo.appintro.R.id.main);
